...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  skills: {
    ...
    openInIDE: (skillId: string, ideType?: string) => ipcRenderer.invoke(IPCChannels.SKILL_OPEN_IN_IDE, skillId, ideType),
  },
...
export interface ElectronAPI {
  ...
  skills: {
    ...
    openInIDE: (skillId: string, ideType?: string) => Promise<void>;
  };
  prompts: {
    create: (config: any) => Promise<string>;
    list: () => Promise<any[]>;
